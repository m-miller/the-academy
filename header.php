...
<!--[if gt IE 8]><!--> <html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<head>
		...
		<script async src="https://www.googletagmanager.com/gtag/js?id=UA-48584643-7"></script>
		<script>
		  window.dataLayer = window.dataLayer || [];
		  function gtag(){dataLayer.push(arguments);}
		  gtag('js', new Date());
		  gtag('config', 'UA-48584643-7');
		</script>
	...
	<body <?php body_class(); ?> itemscope itemtype="http://schema.org/WebPage">
		...
		<div id="container">
			...
			<?php  
				$contents = get_field('hc_header');
				//var_dump($contents['hc_header_style']);
				$hst = $cl = "";
				if( $contents['hc_header_style'] == "Short" ) {
					//$hst = " short";
					//$cl = "no-bg";
				} elseif ( $contents['hc_header_style'] == "Medium" ) {
					//$hst = " medium";
				}
				if ( $contents['hc_header_image'][0] == 'No' ) {
					//$cl = "no-bg";
				} 
				
			?>
			
			<header class="header <?php echo $cl . $hst; ?>" role="banner" itemscope itemtype="http://schema.org/WPHeader" >
